...
//    	hyperlinkLabel
    	hyperlinkLabel.setStyle("-fx-font-color: #FFFFFF; ");
    	hyperlinkLabel.setText("(c) Copyright 2015 [Saxsys]");
    	hyperlinkLabel.setOnAction(new EventHandler<ActionEvent>() {
    	     public void handle(ActionEvent event) {
    	         Hyperlink link = (Hyperlink)event.getSource();
    	         final String str = link == null ? "" : link.getText();
    	         switch(str) {
    	             case "Saxsys": // do 'here' action
    	            	 mainApp.openWeb("http://www.saxsys.de");
    	             break;
    	         }
    	     }
    	 });
